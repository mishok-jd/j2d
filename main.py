...
moves2_json = "input/" + codename + "_moves2.json"
moves3_json = "input/" + codename + "_moves3.json"
songpreviewbeats_json = "input/" + codename + "_SongPreviewBeats.json"
musictrack_name = "output/" + codename.lower() + "_musictrack.tpl.ckd"
